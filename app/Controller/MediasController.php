...
class MediasController extends AppController {
    ...
    **/
    public function index($ref,$ref_id){
        ...
        if (Configure::read('Ads.maxfiles')) {
			$maxfiles = Configure::read('Ads.maxfiles');
		}

        $this->set(compact('id', 'medias', 'thumbID', 'extensions', 'maxfiles'));
    }
    ...
    **/
    public function upload($ref,$ref_id){
        ...
        $id = isset($this->request->query['id']) ? $this->request->query['id'] : false;
        $this->set(compact('media', 'thumbID', 'id'));
        $this->layout = 'json';
        $this->render('media');
        return true;
    }
